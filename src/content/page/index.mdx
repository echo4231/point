...
blocks:
  ...
  - type: recentitems
    ...
    post_tag:
      - Features
    content: >
      forum for exchange of views and experiences; incubator for the development
      of ideas, projects and strategies; virtual place for networking and
      informing socially conscious Internet users; as well as a social network
      for exploring and searching for partners and associates and building
      coalitions.
    title: Featured
style:
  hero_template: image
